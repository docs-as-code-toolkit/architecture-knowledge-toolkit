...
which stays under analysis. Its three remaining relations stay `proposed`,
because their targets are proposed artifacts and the review confirmed the
decision rather than those claims.
