...
- [`skills/architecture-impact`](/skills/architecture-impact/SKILL.md) for keeping feature requests, refactorings, reviews, Epics, and architecture documentation aligned.
